...
with col1:
    Study_Hours_Per_Day = st.number_input('Study Hours Per Day', min_value=0.0, step=0.1)
    Extracurricular_Hours_Per_Day = st.number_input('Extracurricular Hours Per Day', min_value=0.0, step=0.1)
    Sleep_Hours_Per_Day = st.number_input('Sleep Hours Per Day', min_value=0.0, step=0.1)

with col2:
    Social_Hours_Per_Day = st.number_input('Social Hours Per Day', min_value=0.0, step=0.1)
    Physical_Activity_Hours_Per_Day = st.number_input('Physical Activity Hours Per Day', min_value=0.0, step=0.1)
